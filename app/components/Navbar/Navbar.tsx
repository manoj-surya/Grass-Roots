                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                <Image src="/images/Logo/Logo.svg" alt="logo" width={48} height={48} />
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    <Link href='https://wa.me/c/919886103646' className='flex gap-2'>
                                    <Image src={'/images/Navbar/phone.svg'} alt="phone-image" width={19} height={19} />
                                    <p className='text-lg font-medium'>9886103646</p>
                                    </Link>
                                </div>
